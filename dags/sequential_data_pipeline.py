...
load_to_snowflake = SQLExecuteQueryOperator(
    ...
    sql="""
        ...
        VALUES (
          {{ ti.xcom_pull('save_summary_locally')['data']['total_transactions'] }},
          {{ ti.xcom_pull('save_summary_locally')['data']['total_amount'] }},
          {{ ti.xcom_pull('save_summary_locally')['data']['avg_transaction'] }},
          {{ ti.xcom_pull('save_summary_locally')['data']['high_value_count'] }}
        );
    """,
    autocommit=True,
